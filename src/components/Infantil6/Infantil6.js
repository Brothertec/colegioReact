...
export default function infantil3(){
    const listaImagens = [img1, img2, img3, img4, img5, img6, img7, img8, img9, img10, img11, img12, img13, img14];
    const listaImagens2 = [img15, img16, img17, img18, img19, img20, img21, img22, img23];
    const listaImagens3 = [ img24, img25, img26, img27, img28, img29, img30, img31, img32, img33, img34];
    const listaImagens4 = [ img35, img36, img37, img38, img39, img40, img41, img42, img43, img44, img45, img46, img47, img48];
    const listaImagens5 = [ img49, img50, img51, img52, img53, img54, img55, img56, img57, img58, img59, img60];
    return(
        <div>  <HomePost
        corFundo="#cae1f9"
    ...
    <HomePost 
        corFundo="#9A4D89" 
        titulo= "Aula 1"
        video = "https://www.youtube.com/embed/2xCXEf5wT1Y"
    />

    <HomePost 
        corFundo="#fff" 
        titulo= "Aula 2 - Português"
        video = "https://www.youtube.com/embed/55aEBClI-W4"
    />

    <HomePost 
        corFundo="#D3696C" 
        titulo= "Aula 3 - Matemática"
        video = "https://www.youtube.com/embed/io_rqxM4NnI"
    />

<HomePost 
        corFundo="#fff" 
        titulo= "Aula 4 - Matemática"
        video = "https://www.youtube.com/embed/_2wiHNXO4bw"
    />
...
<HomePost 
        corFundo="#fff" 
        titulo= "Aula 6 - Português"
        video = "https://www.youtube.com/embed/sx70do3F7MY"
    />

    <HomePost 
        corFundo="#FFF34A" 
        titulo= "Aula 7 - Ciências"
        video = "https://www.youtube.com/embed/Lf7SRGwnfBc"
    />
